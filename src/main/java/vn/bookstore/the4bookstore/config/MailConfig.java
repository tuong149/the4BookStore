...
public class MailConfig {
    ...
    public JavaMailSender javaMailSender() {
        ...
        // Chuẩn hóa Username (bỏ khoảng trắng thừa nếu có)
        String cleanUsername = (username != null) ? username.trim() : "";
        mailSender.setUsername(cleanUsername);

        // Chuẩn hóa Mật khẩu ứng dụng 16 ký tự của Google (tự động xóa khoảng trắng nếu người dùng copy dạng 'abcd efgh ijkl mnop')
