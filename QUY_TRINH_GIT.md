...
- **eature/tên-chức-năng**: Nhánh để làm chức năng mới (VD: eature/trang-dang-nhap, eature/gio-hang).
- **ix/tên-lỗi**: Nhánh để sửa một lỗi (bug) cụ thể (VD: ix/loi-nut-mua-hang).
...
`
*(Lưu ý: Dùng eat: cho tính năng, ix: cho sửa lỗi, docs: cho tài liệu)*
...
3. Chọn gộp từ nhánh của bạn (eature/...) **VÀO** nhánh develop (Tuyệt đối không gộp thẳng vào main).
